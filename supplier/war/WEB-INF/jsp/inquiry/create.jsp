...
<div>
    ...
    <form:form action="/rest/inquiry" method="POST" modelAttribute="inquiry">
        ...
        <div id="inquiry_customer">
            ...
            <form:input id="_customer" path="customer"/>
            <br/>
            <form:errors cssClass="errors" id="_customer" path="customer"/>
        </div>
        <div id="inquiry_replyUrl">
            <label for="_replyUrl">Reply Url:</label>
            <form:input id="_replyUrl" path="replyUrl"/>
            <br/>
            <form:errors cssClass="errors" id="_replyUrl" path="replyUrl"/>
        </div>
        <br/>
