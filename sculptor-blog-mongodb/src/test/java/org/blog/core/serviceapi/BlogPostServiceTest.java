...
public class BlogPostServiceTest extends AbstractJUnit4SpringContextTests implements BlogPostServiceTestBase {
    ...
    public void initTestData() {
        ...
        Comment comment1 = new Comment("Great", "Great Stuff", post);
    ...
    public void testComments() throws Exception {
        ...
        Comment comment1 = new Comment("Comment 1", "I think you are right", post);
        post.addComment(comment1);
        Comment comment2 = new Comment("Comment 2", "I don't agree with you", post);
