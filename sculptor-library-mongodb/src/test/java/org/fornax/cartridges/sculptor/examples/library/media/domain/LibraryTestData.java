...
import static org.fornax.cartridges.sculptor.examples.library.person.domain.PersonName.personName;
...
import org.fornax.cartridges.sculptor.examples.library.person.domain.PersonRepository;
...
public class LibraryTestData {
    ...
    public void saveInitialData() throws Exception {
        ...
        m2.getEngagements().add(new Engagement("Actor", p1, m2));
