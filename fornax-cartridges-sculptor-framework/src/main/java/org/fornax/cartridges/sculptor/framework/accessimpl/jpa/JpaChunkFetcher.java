...
import org.fornax.cartridges.sculptor.framework.accessimpl.ChunkFetcherBase;
...
public abstract class JpaChunkFetcher<T, KEY> extends ChunkFetcherBase<T, KEY> {
    ...
    protected List<T> getChunk(Collection<KEY> keys) {
        ...
        queryStr += getRestrictionPropertyName() + " IN (" + JpaHelper.convertToString(restrictionPropertyValues) +")";
