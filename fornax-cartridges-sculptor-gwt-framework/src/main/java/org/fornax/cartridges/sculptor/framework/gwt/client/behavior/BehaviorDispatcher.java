...
public class BehaviorDispatcher {
	...
	public static class Event {
		 ...
		 * In the case of events generated by tables, this is the row object
		 */
		private Object obj;
		
		/**
		 * The value for the object obj.
		 * In the case of events generated by tables, this is the cell value.
		 * Note this is only filled in for certain types of events, like list box selection events.
		 */
